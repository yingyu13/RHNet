...
class DIIHead_obb(RotatedBBoxHead):
    ...
    def __init__(self,
        ...
        super(DIIHead_obb, self).__init__(
        ...
        for _ in range(num_reg_fcs):
            ...
            self.reg_fcs.append(
                build_activation_layer(dict(type='ReLU', inplace=True)))
        # over load the self.fc_cls in BBoxHead
        self.fc_reg = nn.Linear(in_channels, 5)
    ...
    def init_weights(self):
        ...
        super(DIIHead_obb, self).init_weights()
    ...
    def forward(self, roi_feat, proposal_feat):
        ...
        bbox_delta = self.fc_reg(reg_feat).view(N, num_proposals, 5)
