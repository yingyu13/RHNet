...
class SparseRoIHead_obb(CascadeRoIHead):
    ...
    def __init__(self,
        ...
        super(SparseRoIHead_obb, self).__init__(
            num_stages,
            stage_loss_weights,
    ...
    def forward_train(self,
        ...
        for stage in range(self.num_stages):
            ...
            for i in range(num_imgs):
                normalize_bbox_ccwh = proposal_list[i] / imgs_whwh[i]
    ...
    def simple_test(self,
        ...
        for img_id in range(num_imgs):
            ...
            if rescale:
                ...
                bbox_pred_per_img[:, :4] /= bbox_pred_per_img[:, :4].new_tensor(scale_factor)
            det_bboxes.append(
    ...
    def forward_dummy(self,x,
        ...
        num_imgs = len(img_metas)
        proposal_list = [proposal_boxes[i] for i in range(num_imgs)]
        ori_shapes = tuple(meta['img_shape'] for meta in img_metas)
